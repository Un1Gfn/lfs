...
"x86_64-linux-4.20.7-arch1-1-arch" or
	die "Errno architecture (x86_64-linux-4.20.7-arch1-1-arch) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
